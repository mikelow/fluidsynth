...
/** Set the NRPN value of a generator and set the gen flag to override the nominal value **/
int fluid_voice_set_override_param(fluid_voice_t *voice, int gen, fluid_real_t value);
